...
- [x] **M1. Concept Setting**: 3D 횡스크롤 여정 및 시간의 흐름 연출 상세 기획.
- [x] **M2. High-Perf Boilerplate**: Three.js + ESM 기반의 제로-오버헤드 프로젝트 구조 구축.
- [x] **M3. Lighting & Environment**: Coastal World 스타일의 밝고 화사한 조명 시스템 및 최적화된 공간 연출.

## Phase 2: Core Game Logic (핵심 3D 기능 및 물리 구현)
- [ ] **M4. Asset Pipeline**: Low-Poly GLTF 모델 연동 및 Coastal World 스타일의 부드러운 애니메이션 구현.
- [ ] **M5. Interaction System**: Coastal World의 조작감을 벤치마킹한 모바일 최적화 이동 및 카메라 로직.
